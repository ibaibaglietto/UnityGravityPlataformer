...
//code based on the code from Brackeys with little changes made to work with gravity changes
public class CharacterController2D : MonoBehaviour
{
    ...
    public void Move(float move, bool jump, int gravity, bool paused)
    {
